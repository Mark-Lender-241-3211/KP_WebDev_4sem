...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 3.2. Реализация модуля авторизации и разграничения прав доступа (библиотекарь/читатель)        & 7                  & 27.04.2026    &                     \\ \hline
    Задача 3.3. Разработка CRUD-интерфейса для управления книгами, читателями и журналом выдач     & 7                  & 03.05.2026    &                     \\ \hline

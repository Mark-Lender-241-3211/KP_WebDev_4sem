...
\begin{center}
    ...
    Лендеру Марку Сергеевичу, % нужно указать в дательном падеже (задание кому?)
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих систем и программных продуктов                              & 10                 & 22.03.2026    &                           \\ \hline
    ...
    Задача 3.1. Разработка базовой структуры приложения и вёрстка шаблонов страниц                   & 12                 & 21.04.2026    &                     \\ \hline
    Задача 3.2. Реализация модуля авторизации и разграничения прав доступа (библиотекарь/читатель)   & 8                  & 27.04.2026    &                     \\ \hline
    Задача 3.3. Разработка CRUD-интерфейса для управления книгами, читателями и журналом выдач       & 9                  & 03.05.2026    &                     \\ \hline
    Задача 3.4. Реализация системы поиска и фильтрации книг, формирование статистики                 & 11                 & 09.05.2026    &                     \\ \hline
